...
void ExportCsvFit(const std::string& strFilename, const Workspace& workspace, int num = -1, bool mag = false);
...
void GetTable(std::ostringstream& table, const Workspace& workspace, int fit_num = 0);
